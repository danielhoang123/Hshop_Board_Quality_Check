...
"%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\bossac\1.6.1-arduino/bossac.exe" -i -d --port=COM%tempChar% -U false -e -w  -b "D:\QuocHoang\Upload_QC\Arduino_Firmware\QC_Firmware_Arduino_Due.bin" -R
