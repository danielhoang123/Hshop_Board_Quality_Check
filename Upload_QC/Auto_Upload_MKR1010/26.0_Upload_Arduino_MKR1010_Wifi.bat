...
"%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\bossac\1.7.0-arduino3/bossac.exe" -i -d --port=COM%tempChar% -U true -i -e -w -v "D:\QuocHoang\Upload_QC\Arduino_Firmware\QC_Firmware_Arduino_MKR1010_ScanWifi.bin" -R
