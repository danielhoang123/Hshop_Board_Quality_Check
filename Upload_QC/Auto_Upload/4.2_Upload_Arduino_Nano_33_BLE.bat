...
"%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\bossac\1.9.1-arduino2/bossac.exe" -d --port=COM%tempChar% -U -i -e -w "D:\QuocHoang\Upload_QC\Arduino_Firmware\QC_Firmware_Arduino_Nano33BLE.bin" -R
