...
"C:\Users\PC\AppData\Local\Arduino15\packages\esp32\tools\esptool_py\4.9.dev3/esptool.exe" --chip esp32 --port "COM%tempChar%" --baud 921600  --before default_reset --after hard_reset write_flash  -z --flash_mode keep --flash_freq keep --flash_size keep 0x1000 "D:\QuocHoang\Upload_QC\ESP32_Firmware\ESP32_32S\ScanWifi_Blink_IO2_Led.bootloader.bin" 0x8000 "D:\QuocHoang\Upload_QC\ESP32_Firmware\ESP32_32S\ScanWifi_Blink_IO2_Led.partitions.bin" 0xe000 "D:\QuocHoang\Upload_QC\ESP32_Firmware\ESP32_32S\boot_app0.bin" 0x10000 "D:\QuocHoang\Upload_QC\ESP32_Firmware\ESP32_32S\ScanWifi_Blink_IO2_Led.bin"
if %ERRORLEVEL% equ 0 (
    color 02
