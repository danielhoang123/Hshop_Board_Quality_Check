...
"C:\Users\PC\AppData\Local\Arduino15\packages\arduino\tools\dfu-util\0.10.0-arduino1/dfu-util" --device 0x2341:0x0364 -D "D:\QuocHoang\Upload_QC\Opta_Firmware\OPTA_Blink_1000ms.bin" -a0 --dfuse-address=0x08040000:leave
