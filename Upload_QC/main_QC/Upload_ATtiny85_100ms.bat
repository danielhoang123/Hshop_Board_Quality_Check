...
"C:\Users\PC\AppData\Local\Arduino15\packages\digistump\tools\micronucleus\2.0a4/launcher" -cdigispark --timeout 60 -Uflash:w:D:\QuocHoang\Upload_QC\Attiny85_Firmware\Blink_100ms.hex:i
