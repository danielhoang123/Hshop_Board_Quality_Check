...
"%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\bossac\1.6.1-arduino/bossac.exe" -i -d --port=COM%tempChar% -U true -e -w -v -b "D:\QuocHoang\Upload_QC\Arduino_Firmware\QC_Firmware_Arduino_Due_1s.bin" -R
