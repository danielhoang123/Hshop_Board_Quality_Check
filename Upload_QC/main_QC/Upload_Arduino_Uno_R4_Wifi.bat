...
"C:\Users\PC\AppData\Local\Arduino15\packages\arduino\tools\bossac\1.9.1-arduino5/bossac" -d --port=COM%tempChar% -U -e -w "D:\QuocHoang\Upload_QC\Arduino_Firmware\Check_Pin\QC_Arduino_UNO_R4_Wifi_Pin.ino.bin" -R
if %ERRORLEVEL% EQU 0 (
    color 02
